...
\name{Rob}{Willison}
\address{Bath, Somerset, BA2 3QH}
\mobile{0798 5345 092}

\email{Rob@willison.co.uk}
\homepage{www.robwillison.com}
\github{RobWillison}
\linkedin{robwillison}

\makecvfooter{\today}{Rob Willison~~~·~~~Résumé}{\thepage} % Specify the letter footer with 3 arguments: (<left>, <center>, <right>), leave any of these blank if they are not needed
